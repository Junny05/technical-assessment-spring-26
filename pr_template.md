# [Junze Ke]'s Submission
**Date**: [12/1/2025]

**BU Email**: [junzeke@bu.edu]
...
- [YES] A catchy name and title with a cool font!
- [YES] An interesting and beautiful frontend design with a catchy title and cool fonts and colors that looks good on any screen size.
...
## Screen Recording 
**Link**: [(https://youtu.be/bwbyXZaU4Ts)]

## Written Portion
1. **How did the project go? What parts of it did you most enjoy / find yourself good at?**

I enjoyed writing about my interest; however, I didn't know much about the frontend, and I felt like I couldn't manage to create a good frontend to present my features well. 
...
This technical assessment was not something I expected. If I had another two weeks to work on it, I would've worked on the frontend a lot more so that it could deliver what I want. 
